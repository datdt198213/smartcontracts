...
export interface TestPassInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "OPERATOR_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "freezeBaseOriginalURI",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setProxyApproval",
    values: [boolean]
  ): string;
  encodeFunctionData(
...
export interface TestPass extends BaseContract {
  connect(runner?: ContractRunner | null): TestPass;
  waitForDeployment(): Promise<this>;

  interface: TestPassInterface;
  ...
  PROXY_ROLE: TypedContractMethod<[], [string], "view">;
  ...
  freezeBaseOriginalURI: TypedContractMethod<[], [void], "nonpayable">;
  ...
  setProxyApproval: TypedContractMethod<
    [approval: boolean],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "freezeBaseOriginalURI"
  ...
  getFunction(
    nameOrSignature: "setProxyApproval"
  ): TypedContractMethod<[approval: boolean], [void], "nonpayable">;
  getFunction(
